...
public class ExprParser extends Parser {
	...
	public static final int
		RULE_prog = 0, RULE_var = 1, RULE_expr = 2;
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while (_la==T__4 || _la==IDENTIFICADOR) {
				{
				setState(14);
				_errHandler.sync(this);
	...
	public static class VarContext extends ParserRuleContext {
		...
		public TerminalNode BIN() { return getToken(ExprParser.BIN, 0); }
		public TerminalNode OC() { return getToken(ExprParser.OC, 0); }
		public TerminalNode HEX() { return getToken(ExprParser.HEX, 0); }
