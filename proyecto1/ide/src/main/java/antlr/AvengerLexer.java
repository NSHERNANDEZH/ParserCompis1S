...
public class AvengerLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"STARK", "BANNER", "ROGERS", "THOR", "BOB", "VISION", "WANDA", "LOKI", 
			"FURY", "GAMORA", "NEBULA", "RECRUIT", "ASSEMBLE", "RETURN", "JARVIS", 
			"PARKER", "ODIN", "NOJARVIS", "JARVISJARVIS", "PLUS", "MINUS", "MULT", 
			"DIV", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "SEMI", "COMMA", "BOOL_THOR", 
			"NUMERO_BANNER", "NUMERO_STARK", "STRING_ROGERS", "IDENTIFICADOR", "WS", 
			"COMMENT"
		};
	}
	...
	public AvengerLexer(CharStream input) {
		super(input);
